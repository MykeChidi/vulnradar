# vulnscan/gui - GUI implementation using Tkinter
...
class VulnScanGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("VulnScan - Web Vulnerability Scanner")
    ...
    def create_header(self):
        ...
        # Logo/Title
        title = tk.Label(header_frame, text="VULNSCAN", 
    ...
    def setup_settings_tab(self):
        ...
        self.db_path_var = tk.StringVar(value="vulnscan.db")
